...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='id',
            field=models.UUIDField(default=uuid.UUID('21349080-7b21-401a-b112-bad1b732156c'), help_text='Unique ID for this particular book across whole library', primary_key=True, serialize=False),
        ),
